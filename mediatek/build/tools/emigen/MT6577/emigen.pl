...
#porting P44_For_JRDSH77_CU_ICS2_ALPS.ICS2.MP.V1_P44_.tar.gz
# CustCS_CustemChips:
...
#porting P44_For_JRDSH77_CU_ICS2_ALPS.ICS2.MP.V1_P44_.tar.gz-end
######################################################################################
my $DEV_TYPE;
my $DEV_TYPE1;
my $DEV_TYPE2;
my $NAND_EMMC_ID;
#porting P44_For_JRDSH77_CU_ICS2_ALPS.ICS2.MP.V1_P44_.tar.gz-start
my $FW_ID ;
my $ID_String ;
my $FW_ID_String ;
my $Sub_version;
